...
//                utils.Utils.LOGE("Could not link program: ", null);
//                utils.Utils.LOGE(GLES20.glGetProgramInfoLog(program), null);
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
//                utils.Utils.LOGE("Could not compile shader " + shaderType + ":", null);
//                utils.Utils.LOGE(GLES20.glGetShaderInfoLog(shader), null);
                Log.i(TAG, "Could not compile shader" + shaderType);
    ...
    private void checkGlError(String op) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            //utils.Utils.LOGE("***** " + op + ": glError " + error, null);
